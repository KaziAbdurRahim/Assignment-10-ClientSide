...
const Footer = () => {
  return (
    <footer className="footer bg-base-200 text-base-content p-10 flex justify-evenly flex-wrap">
      <aside>
        <img src={Logo} className='w-16' alt="" />
        <p>
          Chill Gamer
          <br />
          Your gateway to adventurous wonders since 2020
        </p>
      </aside>
      <nav>
        ...
        <div className="grid grid-flow-col gap-4">
          ...
          <a href="https://www.facebook.com/" target="_blank" rel="noopener noreferrer">
            <svg
              ...
              height="24"
              viewBox="0 0 24 24"
              className="fill-current hover:text-blue-300">
