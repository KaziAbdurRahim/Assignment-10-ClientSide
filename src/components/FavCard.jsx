...
const FavCard = ({ poster, title, genres, duration, year, rating, summary, _id , handleRemoveGame}) => {
            ...
            if (result.isConfirmed) {
                try {
                    ...
                    if (response.ok) {
                        ...
                        handleRemoveGame(_id);
    
                        // Show success message
                        Swal.fire({
                            title: "Deleted!",
                            text: "Game has been removed from your favorites.",
                            icon: "success",
                        });
                    } else {
                        const errorData = await response.json();
                        console.error("Failed to delete game:", errorData.message);
                        Swal.fire({
                            title: "Error!",
                            text: "Failed to remove the game from favorites.",
                            icon: "error",
                        });
                    }
                } catch (error) {
